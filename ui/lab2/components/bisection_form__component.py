...
class BisectionFormComponent(CTkFrame):
  ...
  def __calculate(self):
    print('BISECTION CALCULATION', self.controller.get_equation())
    # print(bisection_method(float(self.input_a.get()), float(self.input_b.get()), self.selected_equation))
